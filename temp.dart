class DartClass {
   ...
   DartClass.fromJson(Map<String, dynamic> json) {
      plus_code = json['plus_code'] != null ? new Plus_code.fromJson(json['plus_code']) : null;
...
class Results {
   ...
   Results({this.address_components,this.formatted_address,this.geometry,this.place_id,this.plus_code,this.types});
   ...
   Map<String, dynamic> toJson() {
      ...
      if (this.address_components != null) {
         data['address_components'] = this.address_components.map((v) => v.toJson()).toList();
      }
...
class Viewport {
   ...
   Viewport.fromJson(Map<String, dynamic> json) {
      ...
      southwest = json['southwest'] != null ? new Southwest.fromJson(json['southwest']) : null;
   }
